...
For use in OU, use the dictionary provided [here](/dsdict), and for CLI inference, use [this](/dict-tw-CLI.txt). Do note that due to the fact that there currently is no phonemizer specifically made for Taiwanese, you'll have to just use the base diffsinger phonemizer, and paste the dsdict content into dsdict.yaml.
